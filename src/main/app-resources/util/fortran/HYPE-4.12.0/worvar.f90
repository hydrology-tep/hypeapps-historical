...
!> \{
  ...
  INTEGER, PARAMETER :: fileunit_demc_candidates = 114   !<Fileunit for DEMC candidates output
  INTEGER, PARAMETER :: fileunit_demc_debug = 115   !<Fileunit for DEMC debug output
  ...
  CHARACTER(LEN=24), PARAMETER :: filename_demc_candidates = 'demc_candidates.log'
  CHARACTER(LEN=19), PARAMETER :: filename_demc_debug      = 'demc_debug.log'
!> \}
...
!> \brief Type for holding information about optimization
  TYPE OPTIMIZATIONTYPE
     ...
     LOGICAL  :: DEMC_debug         = .FALSE. !<'DEMC_debug' Switch on/off debug output
...
!> \{
  ...
  INTEGER, PARAMETER :: o_nsigout = 4               !<Output information: Code for number of significant figures for print out
  INTEGER, PARAMETER :: max_oinfo = 4               !<Max number of information types
...
CONTAINS
  ...
  !------------------------------------------------------------------------
  INTEGER FUNCTION set_outvar(itype,dimout,maxout,outv,typ,n,per,ndec,nsig)
