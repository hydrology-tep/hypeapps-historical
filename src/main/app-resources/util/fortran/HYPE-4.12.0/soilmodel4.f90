...
MODULE FLOODPLAIN_SOILMODEL
  ...
  USE HYPEVARIABLES, ONLY : wpmm,fcmm,epmm, &
       ...
       m_soilcoh,m_soilerod,m_sreroexp,m_filtpbuf,m_filtpinner,m_filtpother,m_macfilt,m_pprelmax, &
...
CONTAINS
  ...
  SUBROUTINE soilmodel_4(i,j,isoil,iluse,subid,classarea,prec,cprec,temp, & 
       daylength,rrcscorr,phoscorr,cevpcorr,incorr,oncorr,frozenstate,soilstate,miscstate,surfaceflow,csrunoff,   &
