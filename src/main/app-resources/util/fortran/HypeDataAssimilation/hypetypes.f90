...
CONTAINS
  ...
  SUBROUTINE set_stateinfo(n,ns,nc,na,nsl,nr,nl,ml,mt,stateinfo,frozenstate,soilstate,aquiferstate,riverstate,lakestate,miscstate)
    ...
    INTEGER, PARAMETER :: nsoilstates = 13
    INTEGER, PARAMETER :: naquiferstates = 6
    INTEGER, PARAMETER :: nriverstates = 13
    INTEGER, PARAMETER :: nlakestates = 10
    INTEGER, PARAMETER :: nmiscstates = 11
    ...
    stateinfo(iadd+13)%dims(1:2) = (/nc,n/)
    ...
    stateinfo(iadd+13)%svpoint%d2 => soilstate%oldgrw
    ...
    stateinfo(iadd+13)%dims(1:2) = (/nr,n/)
  ...
  SUBROUTINE allocate_model_states(n,ns,nc,na,nsl,nr,nl,ml,mt,  &
                                   isN,isP,isC,isflood,ist1,ist2,iswetl,isglac,islrice,isirr,isqar,isgsm,  &
    ...
    CALL allocate_soilstate_variables(n,ns,nc,nsl,isN,isP,isC,ist1,soilstate)
    CALL allocate_aquiferstate_variables(na,ns,aquiferstate)
    CALL allocate_riverstate_variables(n,ns,nr,ml,mt,isN,isP,ist1,iswetl,riverstate)
    CALL allocate_lakestate_variables(n,ns,nl,ist2,lakestate)
    CALL allocate_miscstate_variables(n,ns,nc,ist1,isirr,isqar,isflood,isgsm,miscstate)
  ...
  !---------------------------------------------------------------
  SUBROUTINE initiate_state_zero(ns,na,ist1,ist2,iswetl,isglac,islrice,isirr,isqar,isflood,isgsm,   &
                                     frozenstate,soilstate,aquiferstate,riverstate,lakestate,miscstate)
    ...
    CALL initiate_riverstate_zero(ns,ist1,iswetl,riverstate)
    CALL initiate_lakestate_zero(ns,ist2,lakestate)
    CALL initiate_miscstate_zero(ns,ist1,isirr,isqar,isflood,isgsm,miscstate)
  ...
  !>\b Consequences Memory will be allocated
  !---------------------------------------
  SUBROUTINE allocate_soilstate_variables(n,ns,nc,nsl,isN,isP,isC,ist1,soilstate)
  ...
  !>\b Consequences Memory will be allocated
  !---------------------------------------
  SUBROUTINE allocate_riverstate_variables(n,ns,nr,ml,mt,isN,isP,ist1,iswetl,riverstate)
  ...
  !>state
  !---------------------------------------------------------------
  SUBROUTINE initiate_riverstate_submodel(ns,n,isN,isP,ist1,iswetl,indexarray,  &
  ...
  !---------------------------------------------------------------
  SUBROUTINE initiate_riverstate_zero(ns,ist1,iswetl,riverstate)
...
!    ENDIF
  ...
  !>\b Consequences Memory will be allocated
  !---------------------------------------
  SUBROUTINE allocate_miscstate_variables(n,ns,nc,ist1,isirr,isqar,isflood,isgsm,miscstate)
  ...
  !>state
  !---------------------------------------------------------------
  SUBROUTINE initiate_miscstate_submodel(ns,n,ist1,isirr,isqar,isflood,isgsm,indexarray,miscstate,miscstate2)
  ...
  !---------------------------------------------------------------
  SUBROUTINE initiate_miscstate_zero(ns,ist1,isirr,isqar,isflood,isgsm,miscstate)
...
!------------------------------------
  ...
  !-------------------------------------------------
  SUBROUTINE get_soilstate_variables_arraysize(n,ns,nc,nsl,isN,isP,isC,ist1,dim)
  ...
  !-------------------------------------------------
  SUBROUTINE set_soilstate_variables_to_array(n,ns,nc,nsl,isN,isP,isC,ist1,soilstate,iarrfirst,iarrlast,dim,array)
  ...
  !-------------------------------------------------
  SUBROUTINE set_soilstate_variables_from_array(n,ns,nsfil,nc,nsl,isN,isP,isC,ist1,soilstate,iarrfirst,iarrlast,dim,array)
  ...
  !-------------------------------------------------
  SUBROUTINE get_riverstate_variables_arraysize(n,ns,nr,ml,mt,isN,isP,ist1,iswetl,dim)
  ...
  !-------------------------------------------------
  SUBROUTINE set_riverstate_variables_to_array(n,ns,nr,ml,mt,isN,isP,ist1,iswetl,riverstate,iarrfirst,iarrlast,dim,array)
  ...
  !-------------------------------------------------
  SUBROUTINE set_riverstate_variables_from_array(n,ns,nsfil,nr,ml,mt,isN,isP,ist1,iswetl, &
                                                 Nfil,Pfil,T1fil,riverstate,iarrfirst,iarrlast,dim,array)
  ...
  !-------------------------------------------------
  SUBROUTINE get_miscstate_variables_arraysize(n,ns,nc,ist1,isirr,isqar,isflood,isgsm,dim)
  ...
  !-------------------------------------------------
  SUBROUTINE set_miscstate_variables_to_array(n,ns,nc,ist1,isirr,isqar,isflood,isgsm,miscstate,iarrfirst,iarrlast,dim,array)
  ...
  !-------------------------------------------------
  SUBROUTINE set_miscstate_variables_from_array(n,ns,nsfil,nc,ist1,isirr,isqar,isqar2,isflood,isgsm,miscstate,iarrfirst,iarrlast,dim,array)
