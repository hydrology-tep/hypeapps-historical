...
!> \{
  ...
  INTEGER,PARAMETER :: o_upte    = 65   !<Output variable index
  ...
  INTEGER,PARAMETER :: o_upsd    = 129  !<Output variable index
  ...
  INTEGER,PARAMETER :: o_sml2    = 198  !<Output variable index
  INTEGER,PARAMETER :: o_sml3    = 199  !<Output variable index
  ...
  INTEGER,PARAMETER :: o_upfp    = 219  !<Output variable index
  INTEGER,PARAMETER :: o_xobsm   = 220  !<Output variable index (220-229)
  INTEGER,PARAMETER :: o_xobss   = 230  !<Output variable index (230-239)
  INTEGER,PARAMETER :: o_uppr    = 243  !<Output variable index
  INTEGER,PARAMETER :: o_upev    = 244  !<Output variable index
  INTEGER,PARAMETER :: o_upsn    = 245  !<Output variable index
  INTEGER,PARAMETER :: o_upso    = 246  !<Output variable index
  INTEGER,PARAMETER :: o_specificq    = 247  !<Output variable index
!  INTEGER,PARAMETER :: o_snowfall = 275  !class
!  INTEGER,PARAMETER :: o_rainfall = 276  !class
  INTEGER,PARAMETER :: o_uppe    = 277  !<Output variable index
  ...
  INTEGER,PARAMETER :: o_upme    = 332  !<Output variable index
  ...
  INTEGER,PARAMETER :: o_clrf    = 348  !local runoff in mm/tstep (normalized from cloc (m3/s) by local basin area upstream main river and olake)
  INTEGER,PARAMETER :: o_clrp    = 349  !calculated precipitation on lakes and rivers, mm/tstep
  INTEGER,PARAMETER :: o_clre    = 350  !calculated evaporation from lakes and rivers, mm/tstep
  INTEGER,PARAMETER :: o_qcin    = 351  !calculated local reservoir inflow, m3/s, only calculated as regional outvar, rgqcin = {rgclrf(X)*weights(X) + (rgclpr(Y)+rgclev(Y))*weights(Y)} * (m3/s)/(mm/tstep)
  INTEGER,PARAMETER :: o_qrin    = 352  !recorded   local reservoir inflow, m3/s
  INTEGER,PARAMETER :: o_rmwl    = 353  !recorded   main river water level, m
  INTEGER,PARAMETER :: o_rmwd    = 354  !recorded   mail river water flow, m3/s
  INTEGER,PARAMETER :: o_cmwl    = 355  !calculated main river water level, m
  INTEGER,PARAMETER :: o_amwl    = 356  !altimetry  main river water level, m
...
!> \{
  ...
  INTEGER,PARAMETER :: m_denit3reg  = 4  !<Water quality parameter region parameter index
  !>\}
